...
textarea::placeholder, select>option, input[type=text]::placeholder{color:black; font-size:14px !important;}
...
<script>
	$(function(){
		...
		//이벤트 시작 시간 가져오기
		$("#m_main_starttime li").each(function(){
		...
		//이벤트 종료 시간 가져오기
		$("#m_main_endtime li").each(function(){
  ...
  <form method="post" action="EventModifyAction.eve" enctype="multipart/form-data" id = "p_event_modify_form">
   ...
   <div class="row">
    ...
    <div class="row">
 	...
 	<div class = "row">
	<input type="hidden" name="event_date" id="date" value="${eventdata.event_date}">
	<input type="hidden" name="event_start" id="starttime" value="${eventdata.event_start}">	
	<input type="hidden" name="event_end" id="endtime" value="${eventdata.event_end}">
	<input type="hidden" name="event_num" value="${eventdata.event_num}">
		...
		<div class="m_main_select col-md-6 form-control">
							<div class="m_write col-md" id="m_write_date">
								<div>
									...
									<span>${fn:substring(eventdata.event_date,0,11)}</span>
								</div>
		...
		<div class="m_main_select col-md-3 form-control">
							<div class="m_write col-md" id="m_write_starttime">
								...
								<span>${eventdata.event_start}시</span>
								<i class="fas fa-chevron-down"></i>
							</div>
			...
			<div class="m_main_select col-md-3 form-control">
							<div class="m_write col-md" id="m_write_endtime">
								<i class="far fa-clock"></i>
								<span>${eventdata.event_end}시</span>
								<i class="fas fa-chevron-down"></i>
							</div>
							<div id="m_main_endtime" class="col-md" name = "event_end" value = "">
								<ul>
									<li>10시</li>
									<li>11시</li>
									<li>12시</li>
