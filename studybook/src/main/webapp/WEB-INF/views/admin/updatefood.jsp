				...
				<div class="row">
					<div class="col-md-4">
						<div class="form-group">
							<label class="control-label">음식 코드</label> <input type="text"
								name="food_code" id="food_code" maxlength="5"
								class="form-control" value="${fooddata.food_code}" readOnly />
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-4">
						<div class="form-group">
							<label class="control-label">음식 이름 *</label> <input type="text"
								name="food_name" id="food_name" maxlength="16"
								class="form-control" placeholder="음식 이름 입력" required
								value="${fooddata.food_name}" />
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<label class="control-label">음식 가격 *</label> <input type="text"
								name="food_cost" id="food_cost" maxlength="60"
								class="form-control" placeholder="음식 가격 입력" required
								value="${fooddata.food_cost}" numberOnly />
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="imgcontainer">
								...
								<c:if test="${!empty fooddata.food_pic}">

									<p class="w_stext w_margin">기존 파일</p>
									<div class="w_img">
										<img class="card-img-top"
											src="resources/image/food/${fooddata.food_pic}">
									</div>
